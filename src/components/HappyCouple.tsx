    ...
    >
      ...
      <div className="container px-4 md:px-8 mx-auto relative z-10 flex flex-col items-center h-full justify-between max-w-4xl py-12">
        ...
        >
          ...
          <div className="text-white/95 text-base sm:text-xl md:text-2xl font-serif tracking-wide px-4 drop-shadow-md max-w-lg mx-auto leading-relaxed mt-4">
            What began as a moment<br />became our forever
          </div>
          <div className="flex items-center justify-center space-x-3 text-[#D4AF37] opacity-90 mt-4">
            <div className="w-6 md:w-10 h-[1px] bg-[#D4AF37]" />
        ...
        <div className="flex flex-col space-y-24 md:space-y-32 w-full mt-auto">
          ...
          >
            <div className="w-[55%] sm:w-1/2 md:w-5/12 flex flex-col items-center text-center space-y-3 md:space-y-4">
              <h3 className="text-xl sm:text-3xl md:text-4xl font-serif text-[#D4AF37] leading-snug drop-shadow-md uppercase tracking-wider">
                KAVINDU HARIN<br />ARACHCHI
              </h3>
              <div className="flex items-center justify-center space-x-2 w-full px-2">
                <div className="h-[1px] bg-white/40 flex-1" />
                <p className="text-white/90 font-sans text-[10px] sm:text-xs md:text-sm tracking-[0.3em] uppercase whitespace-nowrap">
                  The Groom
                </p>
                <div className="h-[1px] bg-white/40 flex-1" />
              </div>
              <p className="text-[#D4AF37] font-serif text-[11px] sm:text-sm md:text-base tracking-wide drop-shadow-sm px-1">
                Son of Mr &amp; Mrs Arachchi
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="w-[55%] sm:w-1/2 md:w-5/12 flex flex-col items-center text-center space-y-3 md:space-y-4">
              ...
              <p className="text-[#D4AF37] font-serif text-[11px] sm:text-sm md:text-base tracking-wide drop-shadow-sm px-1">
                Daughter of Mr &amp; Mrs. Dewanga Arachchi
              </p>
            </div>
          </motion.div>
