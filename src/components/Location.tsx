...
export const Location: React.FC = () => {
  ...
  const mapUrl = `https://maps.google.com/maps?q=Crown%20Regency%20Hotel,%20Badulla&t=&z=15&ie=UTF8&iwloc=&output=embed`;
      ...
      <div className="mt-10 flex justify-center">
        ...
        >
          ...
          <div className="w-full h-full rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] border-[8px] sm:border-[12px] border-white relative group/map">
            ...
            <div className="absolute top-6 right-6 bg-transparent90 backdrop-blur-md px-4 py-2 rounded-full border border-brand-gold/30 shadow-lg flex items-center gap-2 pointer-events-none z-30">
