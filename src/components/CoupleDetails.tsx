      ...
      <div className="text-center mb-16 sm:mb-24 relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl sm:text-7xl font-display text-stone-800 tracking-tight drop-shadow-sm">
            Danuja <span className="italic text-brand-primary font-light mx-2">&</span> Thaniya
          </h2>
        </motion.div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-8 relative z-10">
        ...
        >
          <div className="mb-4 flex flex-col items-center lg:items-end">
            ...
            <h3 className="text-4xl sm:text-5xl font-display text-stone-800 mb-2 drop-shadow-sm">Danuja</h3>
            <p className="text-stone-500/90 font-serif italic text-base sm:text-lg">Son of H Jayalath Silva and J A Udayanganie priyadarshika</p>
          </div>
        ...
        >
          <div className="mb-4 flex flex-col items-center lg:items-start">
            ...
            <h3 className="text-4xl sm:text-5xl font-display text-stone-800 mb-2 drop-shadow-sm">Thaniya</h3>
            <p className="text-stone-500/90 font-serif italic text-base sm:text-lg">Daughter of K A Gamini Appuhami and M D R Geethani Silva</p>
          </div>
